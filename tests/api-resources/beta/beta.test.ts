...
describe('resource beta', () => {
  ...
  test('fetchPlanVersion: only required params', async () => {
    const responsePromise = client.beta.fetchPlanVersion('version', { plan_id: 'plan_id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('fetchPlanVersion: required and optional params', async () => {
    const response = await client.beta.fetchPlanVersion('version', { plan_id: 'plan_id' });
  });
