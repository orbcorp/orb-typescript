...
describe('resource invoices', () => {
  ...
  test('deleteLineItem: only required params', async () => {
    const responsePromise = client.invoices.deleteLineItem('line_item_id', { invoice_id: 'invoice_id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('deleteLineItem: required and optional params', async () => {
    const response = await client.invoices.deleteLineItem('line_item_id', { invoice_id: 'invoice_id' });
  });
