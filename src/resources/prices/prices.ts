...
export class Prices extends APIResource {
   ...
   * ```
   */
  create(body: PriceCreateParams, options?: RequestOptions): APIPromise<Shared.Price> {
  ...
  ): PagePromise<PricesPage, Shared.Price> {
    return this._client.getAPIList('/prices', Page<Shared.Price>, { query, ...options });
  }
  ...
  evaluateMultiple(
    ...
    options?: RequestOptions,
  ): APIPromise<PriceEvaluateMultipleResponse> {
  ...
  evaluatePreviewEvents(
    ...
    options?: RequestOptions,
  ): APIPromise<PriceEvaluatePreviewEventsResponse> {
...
export type PriceCreateParams =
  ...
  | PriceCreateParams.NewFloatingGroupedTieredMatrixPrice
  ...
  | PriceCreateParams.NewFloatingTieredMatrixWithAllocationPrice
...
export namespace PriceEvaluateMultipleParams {
  export interface PriceEvaluation {
    ...
    price?:
      ...
      | PriceEvaluation.NewFloatingGroupedTieredMatrixPrice
      ...
      | PriceEvaluation.NewFloatingTieredMatrixWithAllocationPrice
