...
export class Customers extends APIResource {
  ...
  ): PagePromise<CustomersPage, Customer> {
    return this._client.getAPIList('/customers', Page<Customer>, { query, ...options });
  }
  ...
  updateByExternalID(
    ...
    return this._client.put(path`/customers/external_customer_id/${id}`, { body, ...options });
  }
}
