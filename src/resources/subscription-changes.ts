...
export class SubscriptionChanges extends APIResource {
   ...
   */
  list(
    query: SubscriptionChangeListParams | null | undefined = {},
    options?: RequestOptions,
  ): PagePromise<SubscriptionChangeListResponsesPage, SubscriptionChangeListResponse> {
    return this._client.getAPIList('/subscription_changes', Page<SubscriptionChangeListResponse>, {
      query,
      ...options,
    });
  }
