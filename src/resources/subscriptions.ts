...
export class Subscriptions extends APIResource {
  ...
  list(
    ...
    options?: RequestOptions,
  ): PagePromise<SubscriptionsPage, Subscription> {
    return this._client.getAPIList('/subscriptions', Page<Subscription>, { query, ...options });
  }
...
export interface Subscription {
  ...
  discount_intervals: Array<
    ...
    | Subscription.TieredPercentageDiscountInterval
  >;
...
export namespace SubscriptionCreateParams {
  ...
  export interface AddPrice {
    ...
    price?:
      ...
      | AddPrice.NewSubscriptionGroupedTieredMatrixPrice
      ...
      | AddPrice.NewSubscriptionTieredMatrixWithAllocationPrice
      | AddPrice.NewSubscriptionMatrixWithThresholdDiscountsPrice
      ...
      | AddPrice.NewSubscriptionDailyCreditAllowancePrice
      | AddPrice.NewSubscriptionMeteredAllowancePrice
  ...
  export namespace AddPrice {
    ...
    export interface NewSubscriptionGroupedTieredMatrixPrice {
      /**
       * The cadence to bill for this price on.
       */
      cadence: 'annual' | 'semi_annual' | 'monthly' | 'quarterly' | 'one_time' | 'custom';
       ...
       */
      grouped_tiered_matrix_config: NewSubscriptionGroupedTieredMatrixPrice.GroupedTieredMatrixConfig;
    ...
    export namespace NewSubscriptionGroupedTieredMatrixPrice {
      /**
       * Configuration for grouped_tiered_matrix pricing
       */
    ...
    export interface NewSubscriptionTieredMatrixWithAllocationPrice {
      /**
       * The cadence to bill for this price on.
       */
      cadence: 'annual' | 'semi_annual' | 'monthly' | 'quarterly' | 'one_time' | 'custom';
       ...
       */
      tiered_matrix_with_allocation_config: NewSubscriptionTieredMatrixWithAllocationPrice.TieredMatrixWithAllocationConfig;
    ...
    export namespace NewSubscriptionTieredMatrixWithAllocationPrice {
      /**
       * Configuration for tiered_matrix_with_allocation pricing
       */
    ...
    export interface NewSubscriptionMatrixWithThresholdDiscountsPrice {
      /**
       * The cadence to bill for this price on.
       */
      cadence: 'annual' | 'semi_annual' | 'monthly' | 'quarterly' | 'one_time' | 'custom';
    ...
    export namespace NewSubscriptionMatrixWithThresholdDiscountsPrice {
      /**
       * Configuration for matrix_with_threshold_discounts pricing
       */
    ...
    export interface NewSubscriptionDailyCreditAllowancePrice {
      /**
       * The cadence to bill for this price on.
       */
      cadence: 'annual' | 'semi_annual' | 'monthly' | 'quarterly' | 'one_time' | 'custom';
    ...
    export namespace NewSubscriptionDailyCreditAllowancePrice {
      /**
       * Configuration for daily_credit_allowance pricing
       */
    ...
    export interface NewSubscriptionMeteredAllowancePrice {
      /**
       * The cadence to bill for this price on.
       */
      cadence: 'annual' | 'semi_annual' | 'monthly' | 'quarterly' | 'one_time' | 'custom';
    ...
    export namespace NewSubscriptionMeteredAllowancePrice {
      /**
       * Configuration for metered_allowance pricing
       */
  ...
  export interface ReplacePrice {
    ...
    price?:
      ...
      | SubscriptionsAPI.NewSubscriptionTieredWithMinimumPrice
      | SubscriptionsAPI.NewSubscriptionGroupedTieredPrice
      | ReplacePrice.NewSubscriptionGroupedTieredMatrixPrice
      | SubscriptionsAPI.NewSubscriptionTieredPackageWithMinimumPrice
      | SubscriptionsAPI.NewSubscriptionPackageWithAllocationPrice
      | SubscriptionsAPI.NewSubscriptionUnitWithPercentPrice
      | SubscriptionsAPI.NewSubscriptionMatrixWithAllocationPrice
      | ReplacePrice.NewSubscriptionTieredMatrixWithAllocationPrice
      | ReplacePrice.NewSubscriptionMatrixWithThresholdDiscountsPrice
      ...
      | ReplacePrice.NewSubscriptionDailyCreditAllowancePrice
      | ReplacePrice.NewSubscriptionMeteredAllowancePrice
      | SubscriptionsAPI.NewSubscriptionMinimumCompositePrice
...
export namespace SubscriptionPriceIntervalsParams {
  export interface Add {
    ...
    price?:
      ...
      | Add.NewFloatingGroupedTieredMatrixPrice
      ...
      | Add.NewFloatingTieredMatrixWithAllocationPrice
      | Add.NewFloatingMatrixWithThresholdDiscountsPrice
      ...
      | Add.NewFloatingDailyCreditAllowancePrice
      | Add.NewFloatingMeteredAllowancePrice
  ...
  export namespace Add {
    ...
    export interface NewFloatingGroupedTieredMatrixPrice {
      /**
       * The cadence to bill for this price on.
       */
      cadence: 'annual' | 'semi_annual' | 'monthly' | 'quarterly' | 'one_time' | 'custom';
    ...
    export namespace NewFloatingGroupedTieredMatrixPrice {
      /**
       * Configuration for grouped_tiered_matrix pricing
       */
      export interface GroupedTieredMatrixConfig {
    ...
    export interface NewFloatingTieredMatrixWithAllocationPrice {
      /**
       * The cadence to bill for this price on.
       */
      cadence: 'annual' | 'semi_annual' | 'monthly' | 'quarterly' | 'one_time' | 'custom';
    ...
    export namespace NewFloatingTieredMatrixWithAllocationPrice {
      /**
       * Configuration for tiered_matrix_with_allocation pricing
       */
      export interface TieredMatrixWithAllocationConfig {
