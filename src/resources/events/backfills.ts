...
export class Backfills extends APIResource {
   ...
   */
  list(
    query: BackfillListParams | null | undefined = {},
    options?: RequestOptions,
  ): PagePromise<BackfillListResponsesPage, BackfillListResponse> {
    return this._client.getAPIList('/events/backfills', Page<BackfillListResponse>, { query, ...options });
  }
...
export declare namespace Backfills {
  export {
    ...
    type BackfillListResponsesPage as BackfillListResponsesPage,
